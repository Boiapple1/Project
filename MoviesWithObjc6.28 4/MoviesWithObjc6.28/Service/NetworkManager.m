...
-(void)fetchMoviesWithPageNumber:(NSInteger)pageNumber completion:(void (^)(PageResult* _Nullable))completion {
    
    NSURL* url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%ld", BASE_MOVIE_URL, (long)pageNumber]];
